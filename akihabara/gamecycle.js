	...
	return gbox.addObject({
		...
		gameMenu:function(reset) {
			if (reset) {
				...
				if (toys.ui.menu(this,"difficulty",{audiooption:"default-menu-option",audioconfirm:"default-menu-confirm",font:"small",keys:{up:"up",down:"down",ok:"a",cancel:"b"},selector:"*",items:["EASY","NORMAL","HARD"],x:500,y:300})) {
					if (toys.getToyValue(this,"difficulty","ok") == -1) return -15
					else {
